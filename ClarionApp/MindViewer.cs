...
namespace ClarionApp
{
	public partial class MindViewer : Gtk.Window
	{
		...
		public void update() {
			...
			l1T.Text = Convert.ToString(leaflet1[0] + leaflet1[1] + leaflet1[2] + leaflet1[3] + leaflet1[4] + leaflet1[5]);
			...
			l2T.Text = Convert.ToString(leaflet2[0] + leaflet2[1] + leaflet2[2] + leaflet2[3] + leaflet2[4] + leaflet2[5]);
			...
			l3T.Text = Convert.ToString(leaflet3[0] + leaflet3[1] + leaflet3[2] + leaflet3[3] + leaflet3[4] + leaflet3[5]);
		}
